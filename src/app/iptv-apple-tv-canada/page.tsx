...
export const metadata: Metadata = {
  ...
  description:
    "Use MapleStreamTV IPTV on Apple TV, iPhone, and iPad in Canada. 25,000+ live channels, NHL, TSN, CBC in 4K. Easy Infuse or IPTV Smarters setup. From $9/month.",
  ...
  openGraph: {
    ...
    title: "IPTV on Apple TV & iPhone in Canada 2026 | MapleStreamTV",
    description: "Use MapleStreamTV IPTV on Apple TV, iPhone, and iPad in Canada. 25,000+ live channels, NHL, TSN, CBC in 4K. Easy Infuse or IPTV Smarters setup. From $9/month.",
        ...
        <section style={{ padding: "60px 16px", background: "#0a0a0a" }}>
          <div style={{ maxWidth: 780, margin: "0 auto" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              {[
                { n: "01", title: "Choose a MapleStreamTV Plan", desc: "Select a plan from $9/month on our pricing page. Pay via Interac e-Transfer or other accepted methods." },
        ...
        <section style={{ padding: "60px 16px", background: "#0d0d0d", textAlign: "center" }}>
          <div style={{ maxWidth: 600, margin: "0 auto" }}>
            ...
            <p style={{ color: "#9ca3af", marginBottom: 32, fontSize: 15 }}>
              Best IPTV Canada service for Apple TV, iPhone, and iPad. Plans from $9/month.
            </p>
