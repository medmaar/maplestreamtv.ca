...
export const metadata: Metadata = {
  ...
  description: "Looking for IPTV near you in Canada? MapleStreamTV serves all Canadian cities — Toronto, Vancouver, Calgary, Montreal and everywhere in between. Free 24h.",
