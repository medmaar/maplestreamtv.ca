...
export const metadata: Metadata = {
  ...
  description: "Best IPTV apps for Canada in 2026. TiviMate, IPTV Smarters Pro, GSE Smart IPTV — top rated tools for Fire Stick, Smart TV, iPhone and Android. Free trial.",
