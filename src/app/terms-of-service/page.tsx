      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-10 text-gray-300 leading-relaxed">
          ...
          <section>
            ...
            <p className="mb-3">All subscriptions are prepaid. Prices are listed in US dollars unless otherwise stated. By purchasing a subscription, you agree that:</p>
            <ul className="list-disc pl-6 space-y-2">
          ...
          <section>
            ...
            <div className="bg-gray-900 rounded-xl p-6 border border-gray-800">
              ...
              <p className="mt-2">WhatsApp: <a href="/chat/wa" target="_blank" rel="noopener noreferrer" className="text-red-400 hover:underline">WhatsApp</a></p>
            </div>
          </section>
        </div>
      </div>
