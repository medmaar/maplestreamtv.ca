...
export const metadata: Metadata = {
  ...
  description: "Compare the best IPTV providers in Canada for 2026. MapleStreamTV is Canada's top-rated IPTV provider. 25,000+ channels, 4K, free trial. IPTV providers.",
