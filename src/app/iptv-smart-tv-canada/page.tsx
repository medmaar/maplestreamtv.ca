        ...
        <section style={{ padding: "60px 16px", background: "#0a0a0a" }}>
          <div style={{ maxWidth: 780, margin: "0 auto" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              {[
                { n: "01", title: "Subscribe to MapleStreamTV", desc: "Choose a plan on our pricing page — starting at $19 CAD/month. Pay securely via Interac e-Transfer." },
        ...
        <section style={{ padding: "60px 16px", background: "#0d0d0d", textAlign: "center" }}>
          <div style={{ maxWidth: 600, margin: "0 auto" }}>
            ...
            <p style={{ color: "#9ca3af", marginBottom: 32, fontSize: 15 }}>
              Get the best IPTV Canada service on your Smart TV. Plans start at $19 CAD/month with a free 24-hour trial.
            </p>
