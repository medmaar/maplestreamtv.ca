...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://maplestreamtv.ca/12-months" },
};
...
const productSchema = {
  "@context": "https://schema.org",
  "@type": "Product",
  name: "MapleStreamTV 1 Year IPTV Plan",
  description: "12 months of IPTV with 25,000+ live channels in Canada in 4K. No contract.",
  ...
  offers: {
    ...
    url: "https://maplestreamtv.ca/pricing/12-months",
