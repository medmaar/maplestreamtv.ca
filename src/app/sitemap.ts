...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${base}/iptv-android-tv-canada`,                  lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${base}/iptv-smart-tv-canada`,                    lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${base}/iptv-apple-tv-canada`,                    lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${base}/iptv-mag-box-canada`,                     lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${base}/iptv-samsung-tv-canada`,                  lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${base}/iptv-lg-tv-canada`,                       lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${base}/iptv-roku-canada`,                        lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${base}/iptv-android-canada`,                     lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${base}/iptv-ios-canada`,                         lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${base}/iptv-windows-canada`,                     lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    // City landing pages
    { url: `${base}/iptv-toronto`,                            lastModified: now, changeFrequency: "monthly", priority: 0.75 },
    { url: `${base}/iptv-vancouver`,                          lastModified: now, changeFrequency: "monthly", priority: 0.75 },
    { url: `${base}/iptv-montreal`,                           lastModified: now, changeFrequency: "monthly", priority: 0.75 },
    { url: `${base}/iptv-calgary`,                            lastModified: now, changeFrequency: "monthly", priority: 0.75 },
    { url: `${base}/iptv-ottawa`,                             lastModified: now, changeFrequency: "monthly", priority: 0.75 },
    { url: `${base}/iptv-edmonton`,                           lastModified: now, changeFrequency: "monthly", priority: 0.75 },
    // Blog
    ...
    { url: `${base}/blog/iptv-vs-satellite-canada`,           lastModified: now, changeFrequency: "monthly", priority: 0.8 },
