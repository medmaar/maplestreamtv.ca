...
export const metadata: Metadata = {
  ...
  description: "MapleStreamTV runs Canada-based IPTV servers for fast, stable streaming. Low-latency IPTV server connections for all Canadian cities. Free 24h trial from.",
