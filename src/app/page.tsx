        ...
        >
          <div className="max-w-2xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center max-w-sm mx-auto sm:max-w-none">
              <a
                href="https://wa.me/17828026280?text=Hi%20IPTV%20Canada%2C%20I%27d%20like%20a%2024h%20free%20trial!"
                target="_blank"
              ...
              <a
                href="mailto:help@iptvsubscriptioncanada.ca?subject=Free%20Trial%20Request"
          ...
          <div className="max-w-7xl mx-auto">
              ...
              <div className="flex flex-wrap gap-x-10 gap-y-4">
                ...
                <div>
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <a href="/dmca" className="text-gray-400 hover:text-white text-sm transition-colors">DMCA</a>
                  </div>
                </div>
                <div>
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <a href="mailto:help@iptvsubscriptioncanada.ca" className="text-gray-400 hover:text-white text-sm transition-colors">
                      Email Support
                    </a>
                  </div>
                </div>
            ...
            >
              <p className="text-gray-600 text-xs">
                © 2026 IPTV Subscription Canada. All rights reserved.
              </p>
              <p className="text-gray-700 text-xs">iptvsubscriptioncanada.ca</p>
            </div>
          </div>
        </footer>
      </main>
