...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://www.maplestreamtv.ca/blog/iptv-vs-cable-canada" },
  openGraph: {
    title: "IPTV vs Cable Canada 2026: Which Is Better? Full Comparison | MapleStreamTV",
    description:
      "IPTV vs cable TV in Canada — we compare price, channels, picture quality, contracts, and flexibility to help you decide which is better in 2026.",
    url: "https://www.maplestreamtv.ca/blog/iptv-vs-cable-canada",
    type: "article",
...
const articleSchema = {
  ...
  mainEntityOfPage: { "@type": "WebPage", "@id": "https://www.maplestreamtv.ca/blog/iptv-vs-cable-canada" },
};
        ...
        <article style={{ maxWidth: 768, margin: "0 auto", padding: "64px 16px" }}>
          ...
          <section style={{ marginBottom: 48 }}>
            ...
            <div style={{ background: "#052e16", borderRadius: 16, padding: 24, border: "1px solid #166534", marginBottom: 16 }}>
              <h3 style={{ fontWeight: 700, fontSize: 19, marginBottom: 16, color: "#4ade80" }}>MapleStreamTV IPTV Canada</h3>
              <div style={{ display: "flex", flexDirection: "column", gap: 8, fontSize: 14, color: "#d1d5db" }}>
            ...
            <p style={{ color: "#d1d5db", fontSize: 14, lineHeight: 1.75 }}>
              View all <Link href="/pricing" style={{ color: "#E53935", textDecoration: "none", fontWeight: 600 }}>MapleStreamTV IPTV Canada plans</Link> with full pricing details.
            </p>
          </section>
          ...
          <section style={{ marginBottom: 40 }}>
            ...
            <p style={{ color: "#d1d5db", lineHeight: 1.75, marginBottom: 16 }}>
              ...
              A premium IPTV service like MapleStreamTV includes 25,000+ channels from around
          ...
          <section style={{ marginBottom: 40 }}>
            ...
            <p style={{ color: "#d1d5db", lineHeight: 1.75 }}>
              However, premium IPTV providers like MapleStreamTV achieve 99.9% uptime using
          ...
          <div style={{ background: "#111827", border: "1px solid #dc2626", borderRadius: 16, padding: 32, textAlign: "center", marginBottom: 48 }}>
            ...
            <p style={{ color: "#d1d5db", marginBottom: 24 }}>Try MapleStreamTV free for 24 hours — no credit card required.</p>
